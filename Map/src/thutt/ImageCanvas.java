...
class ImageCanvas extends Canvas implements ImageCache.ImageCacheListener
{
	...
	// The layer.
	private int layer;
	// Whether to draw the layer or not.
	...
	public void loadMap(FileStore store, Integer x, Integer y, Integer l) throws IOException
	{
		cache = new ImageCache();
		cache.setListener(this);
		def = cache.LoadMap(store);
